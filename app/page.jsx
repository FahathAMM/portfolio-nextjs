...
//             </p>
//             <div className="flex flex-col xl:flex-row items-center gap-8">
//               <button className="uppercase items-center gap-2 border border-accents py-2 px-4 rounded-lg hover:bg-accent hover:text-primary transition-all duration-500">
//                 <span>Download CV</span>
//                 <FiDownload className="text-xl" />
//               </button>
//               <div className="mb-8 xl:mb-0">
//                 <Social containerStyles="flex gap-6" iconStyles="w-9 h-9 border border-accents rounded-full flex justify-center items-center text-accents text-base hover:bg-accent hover:text-primary transition-all duration-500" />
//               </div>
//             </div>
//           </div>
//           <div className="order-1 xl:order-none mb-8 xl:mb-6">
